...
const Login: React.FC = () => {
  ...
  const { login, loginWithGoogle, error: authError } = useUser();
      ...
      >
        <motion.div variants={itemVariants} className="text-center">
          ...
          <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link to="/register" className="font-medium text-mystical-600 hover:text-mystical-500 dark:text-mystical-400 dark:hover:text-mystical-300">
              {t('auth.signUp')}
            </Link>
          </p>
        </motion.div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link to="/forgot-password" className="font-medium text-mystical-600 hover:text-mystical-500 dark:text-mystical-400 dark:hover:text-mystical-300">
